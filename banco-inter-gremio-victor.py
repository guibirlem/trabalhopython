...
def menu_usuario(cpf):
    ...
    while True:
        ...
        if opcao == 1: 
            print("Função depositar uma opção") #Apagar depois de "linkar" a função correspondente.
            pass #Adicionar aqui a função para Depositar, encontrada na linha 121
            ...
            print("Função fechar conta") #Apagar depois de "linkar" a função correspondente.
            pass #adicionar aqui a função para fechar conta do usuario, FALTA CRIAR
            aguarde_usuario() #NÃO APAGAR PARA FUNCIONAMENTO DO CODIGO DO MENU
        elif opcao == 8:
            print("Função excluir usuário") #Apagar depois de "linkar" a função correspondente.
            pass #Adicionar aqui a função de excluir usuário e conta, FALTA CRIAR
            aguarde_usuario() #NÃO APAGAR PARA FUNCIONAMENTO DO CODIGO DO MENU
            break
        elif opcao == 9:
            break
